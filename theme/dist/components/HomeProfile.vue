...
<script>
import { GithubIcon, BriefcaseIcon, TwitterIcon, HeartIcon, CornerDownRightIcon } from 'vue-feather-icons';
export default {
  components: {
...
.profile-meta-items a {
    color: var(--profile-link-color);
  }

.profile-meta-items a:hover {
